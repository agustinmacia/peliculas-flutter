...
class PeliculaDetalle extends StatelessWidget {
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                ...
                _castingPelicula(context, pelicula),
              ]
            ),
          ),
        ],
  ...
  Widget _castingPelicula(BuildContext context, Pelicula pelicula) {

    final pelProvider = new PeliculasProvider();

    return FutureBuilder(
      future: pelProvider.getActoresDePelicula(pelicula.id.toString()),
